...
//types
import { DeliveryInterface } from './deliveryType'
    ...
    <section className="w-full h-full flex flex-col items-center mt-[16px] gap-[8px]">
      ...
      >
        <div className="w-full h-full overflow-auto flex flex-col items-center relative ">
          ...
          <div className="w-10/12 text-[#505050] py-[16px] text-[18px] font-semibold border-b">
            {shipmentDetails?.recepientFullName}
          </div>
          <div className="w-10/12 text-[#505050] py-[10px] text-[16px]  border-b">
            کد تحویل کالا: {`    `}{' '}
